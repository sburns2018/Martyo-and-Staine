...
namespace MartyoAndStaine {
    public class Enemy : Entity {
        ...
        public Enemy(Game game, int xv, int sx, int sy, int width, int height, SpriteBatch sb, String sn, Rectangle[] platforms, int index) : base(game, xv, sx, sy, width, height, sb, sn) {
